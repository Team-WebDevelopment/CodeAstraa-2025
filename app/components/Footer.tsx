...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-[#1E1A34] to-[#2A1A5E] text-white py-6 px-4 sm:px-10 w-full">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex items-center gap-5 mb-4">
            ...
            />
            {/* Second Logo (IEEE Student Branch) with Gradient */}
            ...
            {/* Third Logo (Galgotias University) */}
            <img
              src=""
          ...
          {/* Text */}
          <div className="text-center md:text-left text-[13px] leading-[1.4] font-light">
        ...
        <div className="flex flex-col items-center justify-center h-full">
          <p className="text-[20px] font-bold mb-3 tracking-wide">SUMMON US ON</p>
