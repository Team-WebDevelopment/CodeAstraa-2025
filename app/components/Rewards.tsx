...
const Rewards: React.FC = () => {
    return (
        <section id="prizes" className="-h-screen bg-[url('/bg2.png')] flex flex-col items-center justify-center bg-inherit relative overflow-hidden bg-repeat-y bg-cover">
            {/* Background */}
                                ...
                                <div className="flex flex-col md:flex-row justify-center items-center gap-6 ">
                                    <div className="flex relative items-center justify-center">
                                        ...
                                        <img
                                            src={slide.image}
                                            alt={slide.title}
                                            className="object-cover h-10/12 md:h-94 rounded-lg absolute top-2 md:top-4 md:right-16"
                                        />
                                    </div>
                                </div>
                            </SwiperSlide>
